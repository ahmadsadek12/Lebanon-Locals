<?php
/**
 * Lebanon Locals - Event Detail API Endpoint
 * GET /api/event-detail.php?id=123
 *
 * @version 1.0.0
 */
...
try {
    ...
    $event['subtypes'] = $subtypeStmt->fetchAll(PDO::FETCH_ASSOC);
    ...
    try {
        ...
        $event['images'] = $imagesStmt->fetchAll(PDO::FETCH_ASSOC);
    ...
    $event['reviews'] = $reviewsStmt->fetchAll(PDO::FETCH_ASSOC);

...
try {
    ...
    // Verify notification belongs to user in main `notifications` table using 'to' column
    ...
    if ((int)$notification['to'] !== (int)$userId) {
        ...
        echo json_encode(['success' => false, 'message' => 'You do not have permission to modify this notification']);
        exit();
    }

    // Mark as read in `notifications` (don't delete, just mark as read)
